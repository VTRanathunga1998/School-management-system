...
-- CreateTable
CREATE TABLE "public"."Annoncement" (
    "id" SERIAL NOT NULL,
    "title" TEXT NOT NULL,
    "description" TEXT NOT NULL,
    "date" TIMESTAMP(3) NOT NULL,
    ...
    CONSTRAINT "Annoncement_pkey" PRIMARY KEY ("id")
);
...
-- AddForeignKey
ALTER TABLE "public"."Annoncement" ADD CONSTRAINT "Annoncement_classId_fkey" FOREIGN KEY ("classId") REFERENCES "public"."Class"("id") ON DELETE SET NULL ON UPDATE CASCADE;
